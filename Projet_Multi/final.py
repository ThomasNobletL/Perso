...
from Modules_Hardware import Ni_Dependencies as NID
from Modules_Hardware import Visa_Dependencies as VID
from Modules_Hardware.Visa_Dependencies import PowerSupply as PS
import time
import numpy as np
...
class MyWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def quit(self):
        ...
        if self.gpp_power_supply is not None:
            self.gpp_power_supply.VID.PS.disconnect()
    ...
    def OPProgram(self):
        subprocess.Popen(["python", "CommandeMicroscope"], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
    ...
    def connect_to_gpp_4323(self):
        ...
        try:
            ...
            if currentText == '':
                ...
                self.gpp_power_supply = PS.PowerSupply(currentText)
    ...
    def displayImage(self, np_image):
        ...
        try:
            ...
            ImPr.normalize(np_image)
            if scanning_mode=="Triangle":
                ImPr.triangle_scanning(np_image,pixels_number)
...
class SweepThread(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            data = Scanning.Scanning(self.time_per_pixel, self.sampling_frequency, self.pixels_number, self.channel_lr,
